...
import com.qiugong.advance.x15.service.ProxyService;
...
public class IActivityManagerProxy implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        if ("startActivity".equals(method.getName())) {
            ...
            Log.d(TAG, "hook startService success");
            Intent intent;
            int index = 0;
            for (int i = 0; i < args.length; i++) {
                if (args[i] instanceof Intent) {
            ...
            Intent subIntent = new Intent();
            String packagerName = "com.qiugong.book";
            subIntent.setClassName(packagerName, "com.qiugong.advance.x15.service.ProxyService");
